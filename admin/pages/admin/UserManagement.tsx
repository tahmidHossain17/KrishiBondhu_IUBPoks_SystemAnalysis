...
const UserManagement: React.FC = () => {
  ...
  const userData = {
    ...
    customers: [
      {
        id: 'C001',
        name: 'Dhaka Mart Supermarket',
        email: 'contact@dhakamart.com',
        phone: '+880 9123456789',
      ...
      {
        id: 'C002',
        name: 'Baishakhi Foods Restaurant',
        email: 'orders@baishakhifoods.com',
    ...
    warehouses: [
      {
        id: 'W001',
        name: 'Dhaka Central Warehouse Ltd',
        email: 'manager@centralwh.com',
        phone: '+880 120-4567890',
    ...
    delivery: [
      {
        id: 'D001',
        name: 'Rashidul Islam',
        email: 'rashidul.delivery@email.com',
        phone: '+880 9876543210',
        location: 'Sector 15, Uttara, Dhaka',
        joinDate: '2023-08-15',
        status: 'active',
        verified: true,
        deliveries: 1247,
