...
const CustomerOrderTracking: React.FC = () => {
  ...
  const mockOrderDetails = {
    ...
    deliveryAddress: '15 Dhanmondi, Dhaka-1205, Bangladesh',
    paymentMethod: 'bKash Payment',
    farmer: 'Mohan Lal',
    farmerPhone: '+91 8765432109',
    currentLocation: { lat: 19.0760, lng: 72.8777 },
    pickupLocation: 'KrishiBondhu Warehouse, Dhaka',
    deliveryLocation: '15 Dhanmondi, Dhaka',
    timeline: [
      {
        step: 'Order Placed',
      ...
      },
      {
        ...
        time: '2024-01-12 10:35 AM',
        status: 'completed',
        description: 'Farmer Mohan Lal has been notified'
      },
      {
        step: 'Product Preparation',
        time: '2024-01-12 02:15 PM',
        status: 'completed',
        description: 'Products have been prepared and quality checked'
      },
      {
        step: 'Warehouse Pickup',
        time: '2024-01-13 09:00 AM',
        status: 'completed',
        description: 'Delivery partner picked up from warehouse'
      },
      {
        step: 'In Transit',
    ...
    deliveryUpdates: [
      {
        time: '2024-01-15 11:30 AM',
        message: 'Package picked up from warehouse and is in transit',
        location: 'Dhaka, Bangladesh'
      },
      {
        time: '2024-01-15 02:45 PM',
        message: 'Package arrived at Dhaka distribution center',
        location: 'Dhaka, Bangladesh'
      },
      {
        time: '2024-01-15 04:20 PM',
        message: 'Package out for final delivery',
        location: 'Dhaka, Bangladesh'
      }
    ],
    routeInfo: {
      totalDistance: '150 km',
      remainingDistance: '25 km',
