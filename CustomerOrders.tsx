  ...
  const mockOrders = [
    {
      ...
      status: 'delivered',
      items: [
        { name: 'Premium Basmati Rice', quantity: '2 kg', price: 150 },
        { name: 'Fresh Organic Tomatoes', quantity: '1 kg', price: 25 }
      ],
      totalAmount: 225,
      deliveryDate: '2024-01-17',
      deliveryPartner: 'FastCargo',
      trackingNumber: 'FC123456789',
      deliveryAddress: '25/A Dhanmondi, Dhaka-1205, Bangladesh',
    ...
    },
    {
      ...
      status: 'in_transit',
      items: [
        { name: 'Organic Wheat Flour', quantity: '3 kg', price: 96 },
        { name: 'Fresh Onions', quantity: '2 kg', price: 36 }
      ],
      totalAmount: 182,
      estimatedDelivery: '2024-01-16',
      deliveryPartner: 'Express Movers',
      trackingNumber: 'EM987654321',
      deliveryAddress: '15 Agrabad, Chittagong-4100, Bangladesh',
      paymentMethod: 'bKash Payment',
      farmer: 'Dhaka Valley Organic',
      progress: 75
    },
    {
      id: 'ORD-2024-003',
      ...
      status: 'processing',
      items: [
        { name: 'Fresh Potatoes', quantity: '5 kg', price: 75 }
      ],
      totalAmount: 125,
      estimatedDelivery: '2024-01-18',
      deliveryPartner: 'Reliable Logistics',
      trackingNumber: 'RL456789123',
      deliveryAddress: '30 Lalmatia, Dhaka-1207, Bangladesh',
    ...
    },
    {
      ...
      status: 'cancelled',
      items: [
        { name: 'Organic Carrots', quantity: '1 kg', price: 30 }
      ],
      totalAmount: 80,
      cancellationReason: 'Out of stock',
      deliveryAddress: '12 CDA Avenue, Chittagong-4000, Bangladesh',
      paymentMethod: 'Rocket Payment',
      farmer: 'Sylhet Tea & Grains'
    }
  ];
