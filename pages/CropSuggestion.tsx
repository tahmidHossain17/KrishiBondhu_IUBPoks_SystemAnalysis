...
const CropSuggestion = () => {
  ...
  const getCurrentSeasonCrops = (date: Date) => {
    ...
    const seasonalData = {
      "Winter": ["Potato", "Wheat", "Mustard", "Onion", "Garlic", "Peas", "Cabbage", "Tomato"],
      "Summer": ["Maize", "Groundnut", "Sesame", "Rice (Boro)", "Watermelon", "Cucumber", "Cotton"],
      "Monsoon": ["Rice (Aman)", "Rice (Aus)", "Jute", "Vegetables", "Pulses", "Fodder"],
      "Post-Monsoon": ["Late Rice", "Wheat", "Mustard", "Lentils", "Vegetables", "Spices"]
    };
  ...
  const seasonalCalendar = [
    { month: "January", crops: ["Potato", "Tomato", "Cabbage"], season: "Winter" },
    { month: "February", crops: ["Wheat", "Mustard", "Peas"], season: "Winter" },
    { month: "March", crops: ["Maize", "Groundnut", "Sesame"], season: "Summer" },
    { month: "April", crops: ["Rice (Boro)", "Watermelon", "Cucumber"], season: "Summer" },
    { month: "May", crops: ["Jute", "Cotton", "Sugarcane"], season: "Summer" },
    { month: "June", crops: ["Rice (Aus)", "Vegetables", "Fodder"], season: "Monsoon" },
    { month: "July", crops: ["Rice (Aman)", "Maize", "Pulses"], season: "Monsoon" },
    { month: "August", crops: ["Vegetables", "Spices", "Fodder"], season: "Monsoon" },
    { month: "September", crops: ["Late Rice", "Vegetables", "Spices"], season: "Post-Monsoon" },
    { month: "October", crops: ["Wheat", "Mustard", "Lentils"], season: "Post-Monsoon" },
    { month: "November", crops: ["Potato", "Onion", "Garlic"], season: "Winter" },
    { month: "December", crops: ["Vegetables", "Pulses", "Oilseeds"], season: "Winter" }
  ];
            ...
            <Card className="shadow-fresh">
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div>
                    <h4 className="font-medium mb-4">Complete Seasonal Calendar</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        { season: "Winter", months: "Dec-Feb", crops: ["Potato", "Wheat", "Mustard", "Onion"] },
                        { season: "Summer", months: "Mar-May", crops: ["Maize", "Groundnut", "Sesame", "Rice (Boro)"] },
                        { season: "Monsoon", months: "Jun-Sep", crops: ["Rice (Aman)", "Jute", "Vegetables", "Pulses"] },
                        { season: "Post-Monsoon", months: "Oct-Nov", crops: ["Late Rice", "Wheat", "Lentils", "Spices"] }
                        ...
                        >
                          <h4 className="font-medium mb-2">{seasonInfo.season}</h4>
