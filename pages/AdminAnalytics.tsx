...
const AdminAnalytics: React.FC = () => {
  ...
  const geographicPerformance = [
    { region: 'North India', revenue: 850000, users: 6500, orders: 12400, growth: 15.2 },
    { region: 'West India', revenue: 680000, users: 4200, orders: 9800, growth: 11.8 },
    { region: 'South India', revenue: 520000, users: 3800, orders: 7650, growth: 8.9 },
    { region: 'East India', revenue: 290000, users: 1178, orders: 4200, growth: 6.3 }
  ];
