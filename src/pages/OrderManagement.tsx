  ...
  const orders = [
    {
      ...
      items: [
        { name: 'Basmati Rice', quantity: '50 kg', price: 2750, farmer: 'Ram Kumar' },
        { name: 'Wheat Flour', quantity: '25 kg', price: 875, farmer: 'Sita Devi' }
      ],
      totalAmount: 3625,
      deliveryFee: 150,
      commission: 290,
    ...
    },
    {
      ...
      items: [
        { name: 'Fresh Tomatoes', quantity: '20 kg', price: 600, farmer: 'Mohan Lal' },
        { name: 'Onions', quantity: '15 kg', price: 375, farmer: 'Mohan Lal' }
      ],
      totalAmount: 975,
      deliveryFee: 80,
      commission: 78,
    ...
    },
    {
      ...
      delivery: null,
      items: [
        { name: 'Organic Rice', quantity: '10 kg', price: 850, farmer: 'Sita Devi' }
      ],
      totalAmount: 850,
      deliveryFee: 60,
      commission: 68,
