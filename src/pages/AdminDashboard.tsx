...
const AdminDashboard: React.FC = () => {
  ...
  const geographicData = [
    { region: 'North India', users: 6500, color: '#3b82f6' },
    { region: 'West India', users: 4200, color: '#10b981' },
    { region: 'South India', users: 3800, color: '#f59e0b' },
    { region: 'East India', users: 1178, color: '#8b5cf6' }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <MapWidget 
          ...
          markers={[
            { location: { lat: 28.6139, lng: 77.2090 }, label: 'Main Hub', type: 'warehouse' },
            { location: { lat: 28.5355, lng: 77.3910 }, label: 'Storage A', type: 'warehouse' },
